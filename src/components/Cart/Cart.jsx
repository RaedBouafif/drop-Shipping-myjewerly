                                    ...
                                    <div className="coupon_code right">
                                        ...
                                        <div className="coupon_inner">
                                            ...
                                            <div className="checkout_btn">
                                                <CotrolledLinks to="/checkout" className="t-bg-blue-500 t-rounded-sm t-text-white t-py-2 t-px-5 t-justify-center t-flex t-items-center">Proceed to Checkout</CotrolledLinks>
                                            </div>
                                        </div>
                                    </div>
                                </div>
