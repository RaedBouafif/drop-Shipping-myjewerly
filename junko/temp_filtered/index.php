				...
				<div class="form-head d-flex mb-3 mb-md-5 align-items-start">
					...
					<div class="input-group search-area ml-auto d-inline-flex">
						...
						<div class="input-group-append">
							<a hr	ef="javascript:void(0)" class="input-group-text"><i class="flaticon-381-search-2"></i></a>
						</div>	
					</div>	
					<a href="java	script:void(0);" class="btn btn-primary ml-3"><i class="flaticon-381-settings-2 mr-0"></i></a>
				</div>	
                <div class="row">	
